...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card mt-5">
                    <img src="../img/WhatsApp Image 2024-02-20 at 21.46.35_d20929ff.jpg" class="card-img-top" style="height: 500px; width:500px;" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Silahkan Scan QR Ini Untuk Melakukan Pembayaran Melalui ShopeePay atau melalui Link dibawah ini <a href="https://sppay.shopee.co.id/qr/008be08ad1e01ae4016b">https://sppay.shopee.co.id/qr/008be08ad1e01ae4016b</a></h5>
                        <p class="card-text"><small class="text-muted">Terimakasih Telah Mengunjungi Kedai Kami</small></p>
    ...
    <script>
        ...
        document.getElementById("btnSelanjutnya").addEventListener("click", function() {
            ...
            alertDiv.className = "alert alert-success alert-dismissible fade show"; // Menambahkan kelas "show" untuk memunculkan alert
            alertDiv.textContent = "Transaksi telah selesai!";
            document.body.appendChild(alertDiv);

            // Mengarahkan pengguna kembali ke halaman menu setelah 1 detik
            setTimeout(function() {
                window.location.href = "index.php"; // Ganti "index.php" dengan URL halaman menu yang sesuai
            }, 1000);
        });
    </script>


    <footer class="text-center mt-3 bg-body-tertiary">
        <!-- Grid container -->
