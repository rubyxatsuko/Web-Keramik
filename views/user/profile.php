...
<head>
    ...
    <style>
        .gradient-custom {
            ...
            background: linear-gradient(9deg, rgba(0,117,255,1) 27%, rgba(0,177,255,0.8788208385739165) 43%, rgba(24,151,251,1) 67%, rgba(3,0,255,1) 100%);
        }
    </style>
...
<body>
<nav class="navbar navbar-expand-md bg-light sticky-top border-bottom">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mt-1 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link mt-1 text-dark" href="index.php">Product</a></li>
                ...
                <li class="nav-item dropdown" id="profileDropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="../../logout.php" data-toggle="modal" data-target="#logoutModal">Logout</a></li>
                    </ul>
                </li>
            </ul>
        </div>
                        ...
                        <div class="card mb-5 my-5" style="border-radius: .5rem; width: 600px; height:auto;">
                            <div class="row g-0 ">
                                <div class="col-md-4 gradient-custom text-center text-white" style="border-top-left-radius: .5rem; border-bottom-left-radius: .5rem;">
                                    <img src="../../assets/img/undraw_profile.svg" alt="Avatar" class="img-fluid my-5" style="width: 80px;" />
                                    <h5>
                                ...
                                <div class="col-md-8 mt-2 pt-1">
                                    <div class="card-body p-4 mt-5">
                                        ...
                                        <div class="d-flex justify-content-center mb-3 mt-3">
                                            <a href="#!"><i class="fa fa-facebook-f fa-lg me-5 p-2"></i></a>
                                            <a href="#!"><i class="fa fa-twitter fa-lg me-5 p-2"></i></a>
                                            <a href="#!"><i class="fa fa-instagram fa-lg p-2"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
