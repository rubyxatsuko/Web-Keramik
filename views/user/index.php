    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mt-1 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link mt-1 text-dark" href="#product">Product</a></li>
...
<div class="container pelayanan" id="pelayanan">
  ...
  <div class="container" id="product">
    <div class="row mt-5">
      ...
      <!-- START: Text Menu Product -->
      <div class="text-center mb-3">
        <h2 class="text-info">Product</h2>
        <hr>
      </div>
      <!-- END: Text Menu Product -->
  ...
  <script>
    // Menambahkan event listener untuk gambar pada dropdown
    document.getElementById("profileDropdown").addEventListener("click", function(event) {
        event.stopPropagation(); // Mencegah event klik dari propogasi ke parent
