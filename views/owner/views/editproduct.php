...
$query = mysqli_query($conn,"SELECT * FROM tbl_product WHERE id_product = '$id'");
...
<head>
    ...
    <title>Add Data Barang - WM Keramik</title>
                ...
                <div class="container mt-3 my-3 mb-5">
                    ...
                    <div class="container">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h1 class="h5 mb-0 text-gray-800">Page Owner - Edit Produk</h1>
                        </div>
                        <hr>
                        ...
                        <div class="row justify-content-center">
                            ...
                            ?>
                                    ...
                                    $query = mysqli_query($conn, "UPDATE tbl_product SET name_product = '$name', price_product = '$price', image_product = '$nama_file', stok_product = '$stok' WHERE id_product = '$id'");
                                    if ($nama_file != '') {
                                    ...
                                    ?>
                                            ...
                                            ?>
                                                ...
                                                $query = mysqli_query($conn, "UPDATE tbl_product SET image_product ='$nama_file' WHERE id_product = '$id'");
                                                var_dump($query);
                                                if ($query) {
                                                ?>
