...
$query = mysqli_query($conn, "SELECT * FROM tbl_multilevel WHERE id = '$id'");
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container mt-5 my-3 mb-5 justify-content-center">

                    <div class="container justify-content-center">
                        <div class="d-sm-flex align-items-center  justify-content-between">
                            <h1 class="h5 mb-0 text-gray-800">Page Owner - Edit Data Admin</h1>
                        </div>
                        <hr>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-8 mb-4 mt-3 justify-content-center">
                                ...
                                <div class="col-lg-8 mb-4 mt-4 justify-content-center">
                                    <label for="uname" class="form-label">Username</label>
                                    <input type="text" name="uname" class="form-control" id="uname" value="<?= $row['uname']; ?>">
                                </div>
                                <div class="col-lg-8 mb-4 mt-4 justify-content-center">
                                    <label for="upwd" class="form-label">Password</label>
                                    <input type="text" name="upwd" class="form-control" id="upwd" value="<?= $row['upwd']; ?>">
                                </div>
                                <div class="col-md-8 mb-4 mt-5 justify-content-center">
                                ...
                                <button type="submit" class="btn btn-primary mb-3 justify-content-center" name="edit">Simpan Produk</button>
                            </form>
                            <?php
                            ...
                            ?>
                                ...
                                <?php
                                    ...
                                    $query = mysqli_query($conn, "UPDATE tbl_multilevel SET name = '$name',email = '$email', uname = '$username', upwd = '$password', role = '$role' WHERE id = '$id'");
                                    if ($query) {
                                        echo "<script>
