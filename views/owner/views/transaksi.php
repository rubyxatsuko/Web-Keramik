...
if (isset($_GET['id_order'])) {
    ...
    $query = mysqli_query($conn, "UPDATE tbl_orders SET status = 'paid' WHERE orders_id = $id_order");
}
...
<head>
    ...
    <title>Data Transaksi - WM Keramik</title>
            ...
            <div id="content">
             ...
             <div class="container">
                    <div class="d-sm-flex align-items-center justify-content-between">
                        <h1 class="h5 mb-0 text-gray-800">Page Owner - Transaksi</h1>
                    </div>
                    <hr>
                </div>
                <!-- END: Tambah Produk -->
                ...
                <div class="container">
                    <table class="table table-striped table-responsive-sm table-responsive-md table-responsive-lg">
                        ...
                        $number = 1;
                        $query_pesanan = $conn->query("SELECT * FROM tbl_orders JOIN tbl_multilevel ON tbl_orders.id_user=tbl_multilevel.id ");
                        ...
                        ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td><?= $r['date']; ?></td>
                                    <td>
                                        <a href="struk.php?id_order=<?= $r['orders_id']; ?>" class="btn btn-primary">Cetak Struk</a>
                                    </td>
                                </tr>
                            </tbody>
                            <?php $number++; ?>
