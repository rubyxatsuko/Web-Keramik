...
if (isset($_GET['id_order'])) {
    ...
    $query = mysqli_query($conn, "UPDATE tbl_orders SET status_bayar = 'paid' WHERE orders_id = $id_order");
...
<head>
    ...
    <title>Add Data Product - WM Keramik</title>
            ...
            <div id="content">
                ...
                <div class="container">
                    <div class="d-sm-flex align-items-center justify-content-between">
                        <h1 class="h5 mb-0 text-gray-800">Page Owner - Pesanan Produk</h1>
                    </div>
                    <hr>
                </div>
                <!-- END: Tambah Produk -->
                ...
                <div class="container">
                    <table class="table table-striped table-responsive-sm table-responsive-md table-responsive-lg">
                        ...
                        ?>
                        <tbody>
                            <?php while ($r = $query_pesanan->fetch_assoc()) : ?>
                                <tr>
                                    <td><?= $number; ?></td>
                                    <td><?= $r['orders_id']; ?></td>
                                    <td><?= $r['name']; ?></td>
