                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="d-sm-flex align-items-center justify-content-between">
                                <h1 class="h5 mb-0 text-gray-800">Page Owner - Produk</h1>
                            </div>
                            ...
                            <table class="table table-responsive text-center mt-4" style="border: none;">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <a class="pe-3" href="deleteproduct.php?id=<?= $row['id_product']; ?>" onclick="return confirm('Anda mau hapus produk ini?')"><i class="fa fa-trash"></i></a>

                                            <a href="editproduct.php?id=<?= $row['id_product']; ?>"><i class="fa fa-edit"></i></a>
                                        </td>
