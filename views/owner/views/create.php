...
?>
      ...
      ?>
            ...
            ?>
               ...
               $query = mysqli_query($conn, "INSERT INTO tbl_product (name_product, price_product, image_product, stok_product) VALUES ('$name', '$price', '$new_name', '$stok')");
         ...
         <div id="content">
            ...
            <div class="container mt-5 my-3 mb-5">
               <div class="d-sm-flex align-items-center justify-content-between">
                  <h1 class="h5 mb-0 text-gray-800">Page Owner - Tambah Product</h1>
               </div>
               <hr>
